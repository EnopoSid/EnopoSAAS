...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedStoreOwnerNotificationForPOS(Order order, int languageId, string MemberId, bool IsMember);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedStoreOwnerNotificationForOnline(string MemberId,bool IsMember,Order order, int languageId);
        ...
        /// <summary>
        /// Sends an order placed notification to a store owner For Central Kitchen
        /// </summary>
        /// <param name="order">Order instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <param name="EmailIdForKitchen">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedStoreOwnerNotificationForCentralKitchen(Order order, int languageId,string EmailIdForKitchen);
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedCustomerNotificationForPOS(string MemberId, bool IsMember,Order order, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);
        //Added By Surakshith to display memberId in mail for register user end on 15-06-2020
        ...
        /// <param name="attachmentFileName">Attachment file name. If specified, then this file name will be sent to a recipient. Otherwise, "AttachmentFilePath" name will be used.</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendOrderPlacedCustomerNotificationForOnline(string MemberId,bool IsMember,Order order, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);
        //Added By Surakshith to display memberId in mail for register user end on 13-06-2020
        ...
        ///<summary>
        ///Sends a message to packers after order status changes to processing
        ///</summary>
        IList<int> SendOrderProcessedPackersNotification(Order order, int languageId);
        ...
        string GetPdfPackerTemplateHTML(Order order, int languageId);
        ...
        /// <param name="order"></param>
        /// <param name="languageId"></param>
        string GetPdfInvoiceTemplateHTML(Order order, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendFreshOrderPlacedStoreOwnerNotification(Order order, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendFreshOrderPlacedCustomerNotification(Order order, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendFreshDepositCustomerNotification(Order order, int languageId);
