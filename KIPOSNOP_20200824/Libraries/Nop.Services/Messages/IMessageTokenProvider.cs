...
namespace Nop.Services.Messages
{
    ...
    public partial interface IMessageTokenProvider
    {
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddOrderTokensForPOS(string MemberId, bool IsMember,IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddOrderTokensForOnline(string MemberId,bool IsMember,IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddOrderTokensAdminEmail(IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddOrderTokensAdminEmailForPOS(string MemberId, bool IsMember, IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        //Added By Surakshith to display memberId in mail for register user end on 15-06-2020
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddOrderTokensAdminEmailForOnline(string MemberId,bool IsMember,IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        //Added By Surakshith to display memberId in mail for register user end on 13-06-2020
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        /// <param name="ToEmailForKitchen">ToEmailForKitchen</param>
        void AddOrderTokensForCentralKitchen(IList<Token> tokens, string ToEmailForKitchen, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddPackersTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddInvoiceTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <param name="vendorId">Vendor identifier</param>
        void AddFreshOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0);
