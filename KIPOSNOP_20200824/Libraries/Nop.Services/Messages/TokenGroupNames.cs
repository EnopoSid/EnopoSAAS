namespace Nop.Services.Messages
{
    ...
    public static partial class TokenGroupNames
    {
        ...
        /// Represents tokens with information about the order
        /// </summary>
        public const string FreshOrderTokens = "Fresh Order tokens";

        /// <summary>
        /// Represents tokens with information about the order
        /// </summary>
        public const string PackersTokens = "Packers tokens";

        /// <summary>
        /// Represents tokens with information about the Invoice
        /// </summary>
        public const string InvoiceTokens = "Invoice tokens";
