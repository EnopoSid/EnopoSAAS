...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        public virtual Category GetMappedCategoryIdByProductId(int ProdId)
        {
            //prepare parameters
            var ProductId = _dataProvider.GetInt32Parameter("ProductId", ProdId);

            //invoke stored procedure
            var category = _dbContext.EntityFromSql<Category>("usp_GetMappedCategoryId",
