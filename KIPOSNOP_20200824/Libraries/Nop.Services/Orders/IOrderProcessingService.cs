...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest, List<ShoppingCartItem> cart);
        ...
        /// <param name="processPaymentRequest">Process payment request</param>
        /// <returns>Place order result</returns>
        PlaceOrderResult PlaceOrderForOnline(ProcessPaymentRequest processPaymentRequest, List<ShoppingCartItem> cart, string MemberId,bool IsMember, decimal orderTax);
        ...
        /// </summary>
        /// <param name="order">The order</param>
        void ReOrderForPOS(Order order,Customer customer);
