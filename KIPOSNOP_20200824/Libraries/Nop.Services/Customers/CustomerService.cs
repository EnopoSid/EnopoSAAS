    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual Customer GetCustomerByEmail(string email)
        {
            ...
            var query = from c in _customerRepository.Table
                        ...
                        where c.Email == email && c.Deleted==false && (c.IsGuestUser ==false || c.IsGuestUser == null)  
        ...
        public virtual Customer GetCustomerByMobileNumber(string mobileNumber)
        {
            ...
            var query = from c in _customerRepository.Table
                        orderby c.Id
                        /*Added by surakshith for IsGuestUser Start*/
                        where c.MobileNumber == mobileNumber && c.Deleted == false && (c.IsGuestUser == false || c.IsGuestUser == null)
                        /*Added by surakshith for IsGuestUser End*/
                        select c;
            var customer = query.FirstOrDefault();
            return customer;
