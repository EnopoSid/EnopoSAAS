namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// Represents system name of notification customer about placed order
        /// </summary>
        public const string OrderProcessedPackersNotification = "OrderProcessed.PackersNotification";

        /// <summary>
        /// Represents system name of notification customer about placed order
        /// </summary>
        public const string OrderProcessedPackersPdfContent= "OrderProcessed.PackersPdfContent";

        /// <summary>
        /// Represents system name of notification customer about placed order
        /// </summary>
        public const string OrderInvoicePdfContent = "Order.InvoicePdfContent";

        /// <summary>
        /// Represents system name of notification customer about placed order
        /// </summary>
        public const string OrderUpdatedInvoicePdfContent = "Order.UpdatedInvoicePdfContent";
        ...
        /// Represents system name of notification vendor about placed order
        /// </summary>
        public const string OrderFreshPlacedStoreOwnerNotification = "OrderFreshPlaced.StoreOwnerNotification";

        /// <summary>
        /// Represents system name of notification vendor about placed order
        /// </summary>
        public const string OrderFreshPlacedCustomerNotification = "OrderFreshPlaced.CustomerNotification";

        /// <summary>
        /// Represents system name of notification vendor about placed order
        /// </summary>
        public const string FreshOrderTinCartDepositCustomerNotification = "FreshOrder.TinCartDeposit.CustomerNotification";
        #endregion
    }
}