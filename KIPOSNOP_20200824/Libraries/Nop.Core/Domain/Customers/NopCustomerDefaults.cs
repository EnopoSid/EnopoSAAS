...
namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        /// <summary>
        /// Gets a system name of 'posuser' customer role
        /// </summary>
        public static string POSUserRoleName => "POSUser";

        /// <summary>
        /// Gets a system name of 'new user' customer role
        /// </summary>
        public static string NewUserRoleName => "NewUserRole";

        /// <summary>
        /// Gets a system name of 'online customer' customer role
        /// </summary>
        public static string OnlineUserRoleName => "OnlineCustomer";
