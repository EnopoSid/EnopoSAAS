...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        protected virtual void PrepareOrderModelPaymentInfo(OrderModel model, Order order)
        {
            ...
            //payment method info
            var pm = order.PaymentMethodType;// _paymentService.LoadPaymentMethodBySystemName(order.PaymentMethodSystemName);
            model.PaymentMethod = order.PaymentMethodType;// pm != null ? pm.PluginDescriptor.FriendlyName : order.PaymentMethodSystemName;
