...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<KiposCategorySIteStatusService>().As<IKiposCategorySIteStatusService>().InstancePerLifetimeScope();
            builder.RegisterType<FreshMealPlansService>().As<IFreshMealPlansService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<FcartService>().As<IFcartService>().InstancePerLifetimeScope();
            builder.RegisterType<FreshPriceCalculationService>().As<IFreshPriceCalculationService>().InstancePerLifetimeScope();
            builder.RegisterType<FreshOrderTotalCalulationService>().As<IFreshOrderTotalCalulationService>().InstancePerLifetimeScope();
            builder.RegisterType<FreshOrderService>().As<IFreshOrderService>().InstancePerLifetimeScope();
            builder.RegisterType<FOrderItemsService>().As<IFOrderItemsService>().InstancePerLifetimeScope();
            builder.RegisterType<AutoRenewalSubscriptionService>().As<IAutoRenewalSubscriptionService>().InstancePerLifetimeScope();
            builder.RegisterType<FreshPackageTypesService>().As<IFreshPackageTypesService>().InstancePerLifetimeScope();

            builder.RegisterType<POSUserRegistrationService>().As<IPOSUserRegistrationService>().InstancePerLifetimeScope();
            builder.RegisterType<POSOrderService>().As<IPOSOrderService>().InstancePerLifetimeScope(); 
            builder.RegisterType<POS_OrdersMappingService>().As<IPOS_OrdersMappingService>().InstancePerLifetimeScope();

            builder.RegisterType<ActionContextAccessor>().As<IActionContextAccessor>().InstancePerLifetimeScope();
            builder.RegisterType<Order_Pickup_CustDetailsService>().As<IOrder_Pickup_CustDetailsService>().InstancePerLifetimeScope();
            ...
            //builder.RegisterType<EfRepository<FreshCart>>()
            // .As<IRepository<FreshCart>>()
            // //.WithParameter(ResolvedParameter.ForNamed<IDbContext>("nop_object_context_BundledDiscountsObjectContext"))
            // .InstancePerLifetimeScope();
        }
