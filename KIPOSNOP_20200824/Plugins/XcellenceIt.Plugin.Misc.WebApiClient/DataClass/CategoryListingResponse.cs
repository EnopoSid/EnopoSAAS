...
{
    public partial class CategoryListingResponse : CustomerModel
    {
        public IList<CustomCategorySimpleModel> Categories { get; set; }
        ...
        public IList<SpecificationFilters> SpecificationFilter { get; set; }
    ...
    public partial class SpecificationFilterItemResponse
    {
    ...
    public class PriceRangeFilters
    {
