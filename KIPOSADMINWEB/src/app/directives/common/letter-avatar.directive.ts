...
@Component({
  selector: 'avatar',
  template: `
            <div *ngIf="props" [style.background-color]="props.background" [style.width] = "props.width" [style.height] = "props.height" [style.line-height]='props.lineheight' [style.font-size] = 'props.fontSize' [style.border] = 'props.border' [style.border-radius] = 'props.borderradius' [style.text-align] ="props.textalign"> 
...
export class LetterAvatarDirective implements OnInit, OnChanges {
  ...
  generateLetter() {
    ...
    var width = this.avatarData && this.avatarData.width ? this.avatarData.width : 50;
    var height = this.avatarData && this.avatarData.height ? this.avatarData.height : 50;
    ...
    this.props['lineheight'] = this.size + 'px';
      this.props['width'] = this.width + 'px';
      this.props['height'] = this.height + 'px';
