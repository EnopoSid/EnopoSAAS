...
@Component({
    selector: 'vendorenquiry-table',
    templateUrl:"./vendorenquiry.component.html",
    encapsulation: ViewEncapsulation.None
})

export class GetVendorEnquiryComponent implements OnInit{
    ...
    constructor(private spinner: NgxSpinnerService,
        ...
        public service: VendorEnquiryService,
...
exportToPdf() {
    if(this.temp.length!=0){
        ...
        let reportname = "Vendor Enquiry.pdf"
...
exportToExcel(event) {
    if(this.temp.length!=0){
     ...
     $.each(rows, function(index, value) {
        ...
        var filename = "Vendor Enquiry.xlsx";
        var  ws = XLSX.utils.aoa_to_sheet(createXLSLFormatObj);
        const workbook: XLSX.WorkBook = { Sheets: { 'Vendor Enquiry': ws }, SheetNames: ['Vendor Enquiry'] };
