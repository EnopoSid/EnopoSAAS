...
import { kpointsRoutes } from './kpoints.route';
...
imports:[
    NgxSpinnerModule,
        ...
        RouterModule.forChild(kpointsRoutes), 
],
declarations:[KpointsComponent, addManualKpoints],
schemas:[CUSTOM_ELEMENTS_SCHEMA],
exports:[KpointsComponent, addManualKpoints]
})
export class KpointsModule{
